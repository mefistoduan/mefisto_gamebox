				...
				init: function() {
					...
					e.run(function() {
						...
						e.canvas.fillStyle("#FFF").fillScreen().drawImage("logo", i - 480 >> 1, u).drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 555, 480, 7),
							e.buttonLayout.released("difficulty1") ? (l.moduleName = "my score", hideAd(), c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "normal", c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "hard", c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "evil", c(5)) : e.buttonLayout.released("rank") && dp_Ranking()
					}).zone(function() {
						e.canvas.fillStyle("#90EE90").fillScreen().fillStyle("#FFF").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑").drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 555, 480, 7).fillStyle("#000").drawString(a(l.time, "s"), 0, u + 340, e.graphics.VCENTER, !1, null, null, "60px 微软雅黑").fillStyle("#000").drawString("best score:" + a(l.bestTime, "s"), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑"),
						l.time > l.bestTime && e.canvas.fillStyle("#FF0").drawString("new score", 0, u + 240, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑"),
					...
					var l = {
						...
						h = function() {
							...
							if (l.time > 10000) {
								dp_share(l.time);
								alert("good you stay " + l.time / 1000 + "s！")
							};
							e.buttonLayout.clear().create({
								id: "return",
								value: "back",
